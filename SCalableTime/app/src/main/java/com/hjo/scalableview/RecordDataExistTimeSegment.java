...
public class RecordDataExistTimeSegment {
    ...
    private static final String TAG="RecordDataExistTimeSegment";
    /**
     ...
     * </pre>
     */
    private List<Long> coverDateZeroOClockList = new ArrayList<>(); //其中包含的几个00:00:00
    ...
    public RecordDataExistTimeSegment(long startTimeInMillisecond, long endTimeInMillisecond) {
        ...
        try {
            ...
            Log.e("hjo",TAG+" HJO"+coverDateZeroOClockList.toString());
