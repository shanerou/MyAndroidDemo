...
/**
 * 时间尺控件
 * Created by hjo on 2016/12/20.
 */

public class SrollTimeView extends View {
    ...
    public SrollTimeView(Context context) {
        super(context);
    }

    public SrollTimeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public SrollTimeView(Context context, AttributeSet attrs, int defStyleAttr) {
